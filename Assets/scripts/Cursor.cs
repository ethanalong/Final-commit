...
public class Cursor : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (sb)
        {
            ...
            {
                Debug.Log("Input.GetButtonDown 1");
        ...
        else
        {
...

            {
                ...
                if (Input.GetButtonDown("South1"))
                {
                    Debug.Log("Input.GetButtonDown 2");
        ...
        //get input
        Vector2 joy = new Vector2(Input.GetAxis("RightJoyX1"), -Input.GetAxis("RightJoyY1"));
